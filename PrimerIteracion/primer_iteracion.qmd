...
![Figura 1. Arquitectura Edge Computing](edge.png){fig-cap="Figura 1: Despliegue" width="600px" fig-alt="Diagrama de despliegue"}
</div>
<br>
<div style="text-align:center">
![Figura 2. Arquitectura Modelo Vista Vista-Modelo](mvvm.png){fig-cap="Figura 2: Modelo Vista Vista-Modelo" width="600px" fig-alt="Diagrama de modelo vista vista-modelo"}
</div>
<br>
<div style="text-align:center">
![Figura 3. Patrón Single Page Application](spa.png){fig-cap="Figura 3: Patrón Single Page Application" width="350px" fig-alt="Diagrama de patrón Single Page Application"}
</div>
